...
async function getClassBookingsForCurrentWeek() {
  noStore();
  ...
  try {
    ...
    return {
      totalBookings,
      classCount: getClasses.length,
      classes
    };
  } catch (error) {
    console.error("Failed to get class bookings for current week", error);
...
export default getClassBookingsForCurrentWeek;
